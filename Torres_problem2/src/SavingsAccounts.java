...
public class SavingsAccounts {
	 ...
	 *    monthly interest by multiplying the savingsBalance by annualInterestRate divided by
	 *     12—this interest should be added to savingsBalance. Provide a static method modifyInterestRate
	 ...
	 *   of $2000.00 and $3000.00, respectively. Set annualInterestRate to 4%, then
	 *    calculate the monthly interest for each of 12 months and print the monthly
